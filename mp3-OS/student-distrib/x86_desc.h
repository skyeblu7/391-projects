...
/* An interrupt descriptor entry (goes into the IDT) */
/*structs defined for paging od 4MB and 4KB */
typedef union pagedir_4MB_t {
    uint32_t val;
    struct {
      uint32_t present         :1;
...
typedef union pagedir_t {
	pagedir_4KB_t pagedir_KB;
	pagedir_4MB_t pagedir_MB;
} pagedir_t;
extern pagedir_t page_directory[1024] __attribute__((aligned (4096)));
extern pagetable_4KB_t first_page_table[1024] __attribute__((aligned (4096)));
extern pagetable_4KB_t page_table[1024] __attribute__((aligned (4096)));
